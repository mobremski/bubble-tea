...
feature "visitor sees a list of shops" do
  scenario "sees a list of shops and link for new shop" do
    bubblicious = Shop.create(name: 'Bubblicious', address: '33 Harrison Ave', city: 'Boston', state: 'MA', zip: '02111')
    tapioca_town = Shop.create(name: "Tapioca Town", address: "Beach streer", city: "Boston", state: "MA", zip: "02112")
  ...
  scenario "clicks link and is taken to show page for given shop" do
    bubblicious = Shop.create(name: 'Bubblicious', address: '33 Harrison Ave', city: 'Boston', state: 'MA', zip: '02111', description: "Straightforward dumplings for a great price.")
